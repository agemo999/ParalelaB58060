...
using namespace std;
Socket::Socket( char t='s', bool ipv6 = false )
{
...
int Socket::Conectar(string Host1, int Port){
    port=Port;
...
int Socket::obtenermensaje(char * text, int len){
...
int Socket::enviarmensaje(string text){
